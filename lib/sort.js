...
import { SORT_METHODS, SORT_ORDERS, SORT_KEYS, parseSortKeys } from './constants.js';

// Defined in lib/constants.js and re-exported here, so that importing the
// vocabulary does not drag in this module's colour-science dependencies.
// Everything downstream can keep importing them from './sort.js'.
export { SORT_METHODS, SORT_ORDERS, SORT_KEYS, parseSortKeys };
