 ...
 *
 * Deliberately not the full entry list: everything that matched exactly is
 * summarised as a count, and only the entries actually worth a human's
 * attention (per NEEDS_REVIEW) get a row - a hundred "exact, downloaded" rows
