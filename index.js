...
// this version reorganises the original single file into lib/ modules and adds
// several sorting strategies, an analysis cache, animation, watch and
// interactive modes. Run `node index.js --help` for the full surface.
...
main().catch((error) => {
    ...
    if (error instanceof RunError || error instanceof InputDirectoryError) {
